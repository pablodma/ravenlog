  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-foreground">Rank Records</h2>
          <p className="text-muted-foreground mt-1">Track promotions and rank changes</p>
        </div>
        <button
      ...
      <div className="bg-muted/30 rounded-lg p-12 text-center">
        <p className="text-muted-foreground">
          {records.length} rank records in system. Full interface coming soon.
        </p>
      </div>
    </div>
  )
