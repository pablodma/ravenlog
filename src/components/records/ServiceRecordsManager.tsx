    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Track enlistment, discharge, and service status changes</p>
        </div>
        <button
      ...
      <div className="bg-muted/30 rounded-lg p-12 text-center">
        <p className="text-muted-foreground">
          {records.length} service records in system. Full interface coming soon.
        </p>
      </div>
    </div>
  )
