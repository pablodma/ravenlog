...
export default function FormAnalytics() {
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-lg font-semibold text-gray-900">Analíticas de Formularios</h2>
        <p className="text-sm text-gray-500">
          Estadísticas y métricas de rendimiento de los formularios
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            Las analíticas aparecerán aquí cuando los formularios comiencen a recibir tráfico
          </p>
        </div>
      </div>
    </div>
