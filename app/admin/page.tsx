...
type TabType = 'overview' | 'permissions' | 'roles' | 'matrix' | 'users' | 'medals' | 'ranks' | 'units' | 'forms' | 'recruitment' | 'positions'
...
export default function AdminPage() {
  ...
  const tabs = [
    ...
    { id: 'recruitment' as TabType, name: 'Solicitudes', icon: UserPlus, permission: 'recruitment.review_applications' },
    ...
    { id: 'positions' as TabType, name: 'Posiciones', icon: User, permission: 'units.create' },
